...
void Sequence::addElement(Element *elt)
{
    if(vSlist->size()>0){
        ...
        {
            exc::SequenceMatchingException::genererException("Heterogen List",PARAMETRE_INVALIDE,__LINE__);
...
string Sequence::getUid()
{
    return qSid;
}


void Sequence::setUid(string q)
{
    qSid = q;
}
