/****************************************************************************
** Meta object code from reading C++ file 'mdial.h'
**
...
#error "The header file 'mdial.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_myDial_t, stringdata) + ofs \
...
const QMetaObject myDial::staticMetaObject = {
    { &QDial::staticMetaObject, qt_meta_stringdata_myDial.data,
      qt_meta_data_myDial,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *myDial::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_myDial.stringdata))
        return static_cast<void*>(const_cast< myDial*>(this));
