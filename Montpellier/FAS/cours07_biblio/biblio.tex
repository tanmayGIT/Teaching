...
\begin{itemize}
\item Fonctionnalité permettant de mettre en cache la phase de
  compilation d'un fichier source;
\item Création de fichiers avec l'extension \og{}.pyc\fg{}, placés au
  même niveau que les fichiers \og{}.py\fg{} correspondants (dans rép.
  $\_\_pycache\_\_/$ récemment);
